...
const __VIEW_PATH__ = 'examples.03-props-children';
...
class PropsChildrenView extends View {
    constructor(__data__ = {}, systemData = {}) {
        ...
        let {title = '', tone = 'default', __ONE_CHILDREN_CONTENT__ = ''} = __data__;
...
export function PropsChildrenFactory(__data__ = {}, systemData = {}) {
    return new PropsChildrenView(__data__, systemData);
}
export default PropsChildrenFactory;