...
const __VIEW_PATH__ = 'examples.02-state';
...
class StateView extends View {
    constructor(__data__ = {}, systemData = {}) {
        super(__VIEW_PATH__, __VIEW_TYPE__, StateViewController);
        const App = app("App");
...
export function StateFactory(__data__ = {}, systemData = {}) {
    return new StateView(__data__, systemData);
}
