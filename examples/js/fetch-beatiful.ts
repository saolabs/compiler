...
class FetchBeatifulViewController extends SaolaViewController {
    constructor(view) {
...
class FetchBeatifulView extends SaolaView {
...
export default function FetchBeatiful(__data__ = {}, systemData = {}) {
